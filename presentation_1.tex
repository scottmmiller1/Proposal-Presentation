...
\date{February 12, 2020} % Date, can be changed to a custom date
...
\multirow{2}{*}{Communication}
  & Received sale information (0/1) & 0.1356 & \tikzmarkin<2>[hl]{a}0.2992 \\
...
\multirow{3}{*}{Planning \& Expectations}
  ...
  & Expected revenue (USD) & 1,208.6133 & 0.5656\tikzmarkend{a} \\
\hline \\ \\ 
\end{tabular}}
\end{table}
\end{frame}
